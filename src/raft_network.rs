...
pub struct AppData {
    ...
    pub addr: String,
    pub raft: openraft::Raft<crate::raft::TypeConfig>,
    pub log_store: crate::raft::LogStore,
    pub state_machine_store: std::sync::Arc<crate::raft::StateMachineStore>,
...
impl RaftNetwork<TypeConfig> for NetworkConnection {
    async fn append_entries(
        ...
        _option: RPCOption,
    ) -> Result<AppendEntriesResponse<TypeConfig>, crate::typ::RPCError> {
        self.owner
    ...
    async fn install_snapshot(
        ...
        _option: RPCOption,
    ) -> Result<InstallSnapshotResponse<TypeConfig>, crate::typ::RPCError<InstallSnapshotError>>
    {
        self.owner
    ...
    async fn vote(
        ...
        _option: RPCOption,
    ) -> Result<VoteResponse<TypeConfig>, crate::typ::RPCError> {
        self.owner
